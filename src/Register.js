    ...
    <div className='w-full h-screen sm:h-full flex flex-col place-content-center items-center justify-center sm:flex-row text-header_bg_text bg-gray-100 '>
        <div className='hidden sm:grow sm:h-screen bg-cover bg-center bg-no-repeat bg-blend-overlay bg-gray-50 bg-opacity-50 sm:flex flex-col justify-center items-center place-content-center' style={{ backgroundImage : `url(${email})`}}>
            <p>
                <Typed className=' font-Alkalami font-bold text-xl md:text-3xl'
                    strings={['Welcome to Olakay mail']}
                    typeSpeed={40}
                    backSpeed={50}
                    loop
                />
        ...
        <div className='w-full sm:w-[400px] bg-gray-100 flex items-center place-content-center'>
            <form className=' w-full flex flex-col gap-6 max-w-[80%] mx-auto '>
                ...
                <p className=' text-sm font-normal text-red-500'>Email already exist</p>
                <div class="relative">
                ...
                <div class="relative">
                    <input type="password" id="password" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none   focus:outline-none focus:ring-[#0c2139]  focus:border-[#0c2139] peer" placeholder=" " />
                    <label for="password" class="absolute text-sm font-medium   duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-gray-100 px-2 peer-focus:px-2 placeholder:text-sm placeholder:font-normal    peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Password</label>
                </div>
                <div class="relative">
                    <input type="password" id="confirm_password" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none   focus:outline-none focus:ring-[#0c2139]  focus:border-[#0c2139] peer" placeholder=" " />
                    <label for="confirm_password" class="absolute text-sm font-medium   duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-gray-100 px-2 peer-focus:px-2 placeholder:text-sm placeholder:font-normal    peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Confirm password</label>
                </div>
                <button type="button" class=" w-fit py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-white   rounded-lg border border-gray-200 bg-header focus:z-10 focus:outline-none focus:ring-0  ">Register</button>
