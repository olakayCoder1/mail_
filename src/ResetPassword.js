  ...
  return (
    ...
    <div className='w-full sm:w-[400px] bg-gray-100 flex items-center place-content-center'>
        <form className=' w-full flex flex-col gap-6 max-w-[80%] mx-auto '>
            ...
            <p className=' text-sm font-normal '>Enter your new password.</p>
            <div class="relative">
                <input type="password" id="password1" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none   focus:outline-none focus:ring-[#0c2139]  focus:border-[#0c2139] peer" placeholder=" " />
            ...
            <div class="relative">
                <input type="password" id="password_" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none   focus:outline-none focus:ring-[#0c2139]  focus:border-[#0c2139] peer" placeholder=" " />
                <label for="password_" class="absolute text-sm   duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-gray-100  px-2 peer-focus:px-2 placeholder:text-sm placeholder:font-normal    peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Confirm password</label>
            </div>
            <button type="button" class=" w-fit py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-white   rounded-lg border border-gray-200 bg-header focus:z-10 focus:outline-none focus:ring-0  ">Reset password</button>
