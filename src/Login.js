    ...
    <div className='w-full h-screen sm:h-full flex flex-col place-content-center items-center justify-center sm:flex-row text-header_bg_text bg-gray-100 '>
        ...
        <div className='w-full sm:w-[400px] bg-gray-100 flex items-center place-content-center'>
            <form className=' w-full flex flex-col gap-6 max-w-[80%] mx-auto '>
                ...
                <p className=' text-sm font-normal text-red-500'>Invalide login credential</p>
                <div class="relative">
                ...
                <button onClick={()=> navigate('/')}
                     type="button" class=" w-fit py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-white   rounded-lg border border-gray-200 bg-header focus:z-10 focus:outline-none focus:ring-0  ">Login</button>
                <p className=' text-sm font-medium'>Forget password ?  
                    <Link to='/password-forget'><span className='ml-3 hover:underline underline-offset-1'>Reset</span></Link>
                </p> 


                <p className=' text-sm font-medium'>Need an account ?  
                    <Link to='/register'><span className='ml-3 hover:underline underline-offset-1'>Sign up</span></Link>
                </p> 
            </form>
